'use client';
import LoggesdInUser from '../components/providers/loggedInUser';
...
let formFilled = null;
    useEffect(() => {
        formFilled = localStorage.getItem("RidesSearched");
      }, []);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log(data);
            // Optionally redirect or update local storage
            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="container px-6 py-12 mx-auto">
                    <div className="lg:flex lg:items-center lg:-mx-6">
                        ...
                        <div className="mt-8 lg:w-1/2 lg:mx-6 h-[500px] ">
